...
public class MinioService {
    ...
    public String getDownloadFileUrl(String objectName, String bucketName){

        try {
            Map<String, String> reqHeaders = new HashMap<>();
            reqHeaders.put("response-content-disposition", "attachment; filename=\"" + objectName + "\"");

            // Get presigned URL valid for one hour with modified headers for download
            String url = minioClient.getPresignedObjectUrl(
                    GetPresignedObjectUrlArgs.builder()
                            .method(Method.GET)
                            .bucket(bucketName)
